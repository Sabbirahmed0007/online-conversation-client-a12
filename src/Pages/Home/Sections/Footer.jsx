    ...
    return (
        <footer className="footer footer-center p-7 bg-base-200 text-base-content rounded">
            <div>
                ...
                <h2 className='text-3xl font-bold '>ConvoConnect</h2>
            </div>
            <nav className="grid grid-flow-col gap-4">
            <Link to={''} className="hover:text-blue-700">About us</Link>
            <Link to={''} className="hover:text-blue-700">Contact</Link>
            <Link to={''} className="hover:text-blue-700">Jobs</Link>
            <Link to={''} className="hover:text-blue-700">Press kit</Link>
            </nav> 
            <nav>
            ...
            <aside>
            <p className='font-semibold'>Copyright © {currentYear} - All right reserved by ConvoConnect</p>
            </aside>
        </footer>
    );
};
